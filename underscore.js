...
// Bonus Points
const totalByMonth = _.chain(purchases).groupBy('month').map( obj => _.reduce(obj, (totalPrice, purchase) => {return totalPrice + purchase.price} )); // Use the groupded purchasesByMonth and reduce to create a totalByMonth object.
